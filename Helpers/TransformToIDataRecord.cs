...
{
    /// <summary>
    /// Non-generic: infers T from the runtime type of the object.
    /// Usage: TransformToIDataRecord.TransformFromObject(myObj, "Key")
    /// </summary>
    public static class TransformToIDataRecord
    {
        ...
        {
            var recordType = typeof(CustomDataRecord<>).MakeGenericType(data.GetType());
        ...
        public static IEnumerable<IDataRecord> TransformFromList(IList<object> data, string namePrefix)
        {
            ...
            {
                var recordType = typeof(CustomDataRecord<>).MakeGenericType(d.GetType());
    ...
    /// <summary>
    /// Generic: use when you need compile-time type safety or TransformFromList.
    /// Usage: TransformToIDataRecord&lt;MyDto&gt;.TransformFromObject(dto, "Key")
    /// </summary>
