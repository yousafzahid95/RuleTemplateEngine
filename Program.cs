...
var externalMsg = new ExternalGenericEntityEventMessage
{
    ...
    Body = new ActionItemClosedData() { WorkAreaId = Guid.NewGuid() },
    MessageHeaders = new MessageHeadersFields() { ReplyTo ="test"}
};

var dataRecord = TransformToIDataRecord<ExternalGenericEntityEventMessage>.TransformFromObject(externalMsg, "Key");
var dataRecord2 = TransformToIDataRecord.TransformFromObject(externalMsg, "Key");
